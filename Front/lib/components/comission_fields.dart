...
class ComissionFields extends StatefulWidget {
  ...
  const ComissionFields({
    super.key,
    required this.onBalanceChanged,
    required this.onMinComissionChanged,
    required this.onComssionFactorChanged,
  });
      ...
      children: [
        ...
        Row(
          ...
          children: [
            SizedBox(
              width: 120,
              child: Text('Starting balance: ', textAlign: TextAlign.right,),
            ),
            Container(
              width: 200,
              height: 30,
        ...
        // Minimal Commission
        Padding(padding:  const EdgeInsets.only(right: 30),child:
        Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            SizedBox(
              ...
              child: Text('Minimal comission:', textAlign: TextAlign.right,),
            ),
            Container(
              width: 200,
              height: 30,
              ...
              child: TextFormField(
                ...
                textAlignVertical: TextAlignVertical.top,
                onChanged: (value) {
                  minComssion = double.tryParse(value) ?? 0.0;
        ...
        Row(
          ...
          children: [
            SizedBox(
              width: 120,
              child: Text('Comission factor:',textAlign: TextAlign.right,),
            ),
            Container(
              width: 200,
              height: 30,
              ...
              child: TextField(
                ...
                textAlignVertical: TextAlignVertical.top,
                onChanged: (value) {
                  comissionFactor = double.tryParse(value) ?? 0.0;
                  validComissionFator(comissionFactor!)
                      ? widget.onComssionFactorChanged(comissionFactor!)
                      : _showError('Comission factor must be between 0 and 1');
                },
                decoration: const InputDecoration(
                  border: InputBorder.none,
                  contentPadding: EdgeInsets.symmetric(horizontal: 2, vertical: -16),
